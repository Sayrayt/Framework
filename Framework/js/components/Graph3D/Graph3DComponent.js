class Graph3DComponent extends Component {
    ...
    figureAnimantion() {
        ...
        setInterval(() => {
            if (document.getElementById('animation').hasAttribute('checked') && !this.canMove) {
    ...
    render() {
        ...
        if (this.polygonsAreAllowed) {
            ...
            polygons.forEach(polygon => {
                ...
                const lumen = this.graph3D.calcIlluminationDistance(polygon.lumen, this.LIGHT.lumen);
